...
**What this file now holds is two open questions and the nine entries above them.** The mailbox
archive (D-141) and the unbounded candidate scan (D-158) remain open and are the whole of what is
unanswered; D-187 … D-195 sit above them, each settled but recent.
