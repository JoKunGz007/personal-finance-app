...
**What this file now holds is two open questions and the six entries above them.** The mailbox
archive (D-141) and the unbounded candidate scan (D-158) remain open and are the whole of what is
unanswered; D-187 … D-192 sit above them, each settled but recent.
