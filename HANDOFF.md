...
- **As of the D-201 session, read `git log` — this line cannot record the commit that carries it.**
  D-206's code (`32970b4`, notes as a layer) is the newest change to what the app serves, **confirmed live**.
