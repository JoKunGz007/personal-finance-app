...
- **As of the D-200 session, read `git log` — this line cannot record the commit that carries it.**
  D-200's code (`baae8e5`, only a digit run takes the figures font, never a word beside it) is the
