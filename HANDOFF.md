...
- **As of the D-201 session, read `git log` — this line cannot record the commit that carries it.**
  D-204's code (`d8ca844`, the second /ux-review pass) is the newest change to what the app serves,
  **confirmed live**. Beneath it, D-203's (`8294e22`, the first pass), also confirmed live. Beneath it, D-202's (`bda7ba0`, digit-only figures face webwide; long help
