...
- **As of the D-201 session, read `git log` — this line cannot record the commit that carries it.**
  D-202's code (`bda7ba0`, digit-only figures face webwide; long help behind i icons) is the newest
  change to what the app serves, **confirmed live**. Beneath it, D-201's (`0e486b0`, the
