...
[DECISIONS.md](DECISIONS.md) (append-only; indexed at the top, carrying **D-141, D-158, D-212, D-213 and D-214**
...
questions, the two newest entries (D-212, D-214) and the boundary's own record of itself (D-213)** — the mailbox archive (D-141), deferred by
...
- **Real-data read, `db push`, commit, push and hosted web use: GRANTED and SPENT, 2026-09-23 (the D-214 session)**, in the owner's opening line. Spent on pushing 031 after a dry-run and a hosted read of the backup state (69 / 69), on `53fc190` and its docs commit, and on one read of the live `/receipts` statistics panel. The panel's figures were seen in this chat only. **None of this survives into a new session.**
