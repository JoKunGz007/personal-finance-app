...
- **As of the D-201 session, read `git log` — this line cannot record the commit that carries it.**
  D-203's code (`8294e22`, the first /ux-review pass) is the newest change to what the app serves,
  **confirmed live**. Beneath it, D-202's (`bda7ba0`, digit-only figures face webwide; long help
