...
//
// The QR is generated by `tests/fixtures/synthetic-slip.ts` from an invented reference, so
// the grammar is real and the content is not. No real slip reference exists in this repo.
//
