...
//
// The QR is generated by `tests/fixtures/synthetic-slip.ts`. Most of those references are
// invented; **`KTB_SLIP_DATED` is not** — it was copied from a real slip and is a standing
// violation of `docs/FIXTURE_POLICY.md`, recorded rather than quietly fixed (D-060).
//
