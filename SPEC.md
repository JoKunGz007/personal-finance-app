...
Those reads established parsing only, and that limit has since been partly lifted: the KBANK statement was imported on 2026-07-28 (D-047) and the ledger moved to `private-ledger-live` (D-048). The SCB statement was not, and 14 further statements have been read without being imported — see `PLAN.md` task 18. Reconciliation against real rows remains unexercised.
