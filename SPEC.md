...
What those reads did **not** establish: neither statement was imported. Binding, the authenticated import path, and reconciliation against real rows remain unexercised on real input, and doing any of them is gated by § Later authorization gates item 3 in `PLAN.md`. See `PLAN.md` task 11.
